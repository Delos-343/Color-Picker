...
function changeBG()  {
	...
	var images = [
		...
		if(document.getElementByClass("tema-1")) {
		...
		if(document.getElementByClass("tema-2")) {
		...
		if(document.getElementByClass("tema-3")) {
		...
		if(document.getElementByClass("tema-4")) {
		...
		if(document.getElementByClass("tema-5")) {
		...
		if(document.getElementByClass("tema-6")) {
