...
function changeBG()  {
	...
	var images = [
		...
		if(document.getElementById("tema-1")) {
		...
		if(document.getElementById("tema-2")) {
		...
		if(document.getElementById("tema-3")) {
		...
		if(document.getElementById("tema-4")) {
		...
		if(document.getElementById("tema-5")) {
		...
		if(document.getElementById("tema-6")) {
