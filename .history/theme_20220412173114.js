...
function setBlue() {
    document.getElementById("contentBox").style.color = "#87ceeb";
    document.getElementById("contentBox").style.color = "#222";

}

function setOrange() {
    document.getElementById("contentBox").style.color = "#ffa500";
    document.getElementById("contentBox").style.color = "#dcdcdc";

}

function setDark() {
    document.getElementById("contentBox").style.color = "#18191a";
    document.getElementById("contentBox").style.color = "#f1f1f1";

}

function setRed() {
    document.getElementById("contentBox").style.color = "#be0029";
    document.getElementById("contentBox").style.color = "#f1f1f1";
